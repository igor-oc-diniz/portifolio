...
export const experiences: ExperienceEntry[] = [
  ...
  },
  {
    ...
    description: [
      "Co-founding member with full ownership of the mobile application — responsible for all architecture decisions, product design, and feature delivery from the ground up, with no backend involvement.",
    ],
    achievements: [
